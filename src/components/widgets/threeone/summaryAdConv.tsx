...
const SummaryAdsConv = ({ variant, className }: SummaryAdsConvProp) => {
  const data = [
    ...
    <WidgetBox
      ...
      <div className="p-4 text-xs text-gray-400">
        <LineChart
          ...
          <YAxis
            tick={({ x, y, payload }) => (
              <text x={x} y={y} fill="#e5e7eb" fontSize={10} textAnchor="end">
                {payload.value}
              </text>
            )}
          />
      ...
      <div className="p-4">
        <div>
          <div className="flex flex-col justify-between mt-4 px-2 border-l-8 border-indigo-400">
            ...
            <div className="text-gray-200 text-sm">400</div>
          </div>
          <div className="flex flex-col justify-between mt-4 px-2 border-l-8 border-orange-500">
            ...
            <div className="text-gray-200 text-sm">240</div>
          </div>
          <div className="flex flex-col justify-between mt-4 px-2 border-l-8 border-green-500">
            <div className="text-gray-500 text-xs font-semibold">Instagram</div>
            <div className="text-gray-200 text-sm">320</div>
          </div>
          <div className="flex flex-col justify-between mt-4 px-2 border-l-8 border-yellow-400">
            <div className="text-gray-500 text-xs font-semibold">Twitter</div>
            <div className="text-gray-200 text-sm">200</div>
          </div>
        </div>
      </div>
    </WidgetBox>
...
export default SummaryAdsConv;

type SummaryAdsConvProp = {
